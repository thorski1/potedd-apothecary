...
export default function Home() {
	return (
		<main className="min-h-screen">
			...
			/>
				<Introduction
					content="At Pot.EdD Apothecary, our mission is to preserve native fruit and plant species by growing them in harmony with nature. We follow micro-local, sustainable practices to ensure that all our plants thrive in the healthiest environment."
				/>
				<FeaturedProducts
